...
/*
 * Last changes made by $Author: markus $, $Date: 2008-10-09 12:00:49 +0200 (Do, 09 Okt 2008) $
 */
...
public class LoadDocumentOperation implements IRunnableWithProgress {
	...
	public void run(IProgressMonitor progressMonitor) throws InvocationTargetException, InterruptedException {
		...
		while (!internalThread.done()) {
			...
			//and kill the internalThread if that it exceeded.
			...
			//NOTE: The NOAText js and NOAText jsl implementations of the NOAText plugin, take numerous preconditions
