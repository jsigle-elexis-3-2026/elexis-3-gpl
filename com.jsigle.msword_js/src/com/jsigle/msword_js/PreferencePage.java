...
public class PreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	//separatem Druecken des Buttons "Anwenden" speichern (laesst das nachfolgende performApply aus).
	//Der direkt neben diesem liegend Button "Standardwerte wiederherstellen" hingegen setzt
	//*alle* darueberliegenden Felder zurueck, aber nicht die beiden vorgenannten checkboxes...
	//Das ist beides sehr inkonsequent und kontra-intuitiv. Tatsaechlich muesste der Button
	//"Anwenden und Schliessen" auch die gewaehlten Einstellungen der beiden checkboxes
	//ganz unten mit erfassen. Leider leider leider finde ich mal wieder nicht in endlicher
	//Zeit heraus, wo nun die Funktionalitaet dieses Buttons implementiert ist - oder wie man
	//sie auf die beiden uebrigen checkboxes ausdehnt. Vermutlich steht das wieder in einem
	//ganz anderen File fuer eine ganz andere Klasse etc. - darum moege das bitte upstream richten.
	//P.S.: Nicht mal mit einer Suche nach "Anwenden und Schliessen" ueber alle Files finde ich auch
	//nur den Text dieses Buttons, das duerfte also ein Stock button eines Standarddialogs sein -
	//und somit auch dessen Funktion "irgendwo" definiert, vielleicht auch mehrere Generationen
	//weiter oben, und waere hier mittels irgendeines Overrides zu erweitern...
	@Override
	protected void performApply(){

	//TODO: 20260102js: Apparently, CoreHub.userCfg has been removed upstream.
	//TODO:	20260102js: That may NOT be very problematic, as the configuration for 
		System.out.println("TODO: PreferencePage.java: CoreHub.userCfg.flush() does not exist any more. Commented out the call. Was this needed? / Replace by...?");
